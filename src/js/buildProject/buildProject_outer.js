            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: function (value) {
                        console.log(value);
                        return '<a href="projectDetails_outer.html">'+ value +'</a>'
                    }
                },
                {
                    field: 'field8',
                ...
                },
                {
                    ...
                    formatter: function() {
                        var a = [
                            '<a href="javascript:void(0);" class="onOff"><span class="text-blue">启用</span><i class="iconfont icon-kaiguan3" style="font-size: 30px;"></i><span>冻结</span></a>'
                        ].join('');
                        return a;
                    }
                },
                ...
                },
                {
                    ...
                    valign: 'middle',
                    formatter: function () {
                        var a = '<a href="javascript:void(0);"><i class="iconfont icon-xiugai"></i></a>'
                        return a;
                    }
                },
                {
                    ...
                    formatter: function() {
                        var a = [
                            '<a href="javascript:void(0);" class="onOff"><span class="text-blue">是</span><i class="iconfont icon-kaiguan3" style="font-size: 30px;"></i><span>否</span></a>'
                        ].join('');
                        return a;
                    }
                },
